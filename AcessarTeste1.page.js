...
class AcessarTeste1Page {

    static acessarPaginaTeste1() {
        cy.visit('https://marcosqa.github.io/localhost/')
    ...
    static preencherCamposDoFormulario() {
        ...
        AcessarTeste1Elements.inputValidade().type('31/12/2021')
    ...
    static validarDataPosterior() {
        ...
        AcessarTeste1Elements.inputValidade().type('02/08/2024')
        AcessarTeste1Elements.btnAdicionarProduto().click()
        AcessarTeste1Elements.validarNomeFormulario()
            .should('contain', 'Validade')
        AcessarTeste1Elements.validarNomeNoFormulario()
...
export default AcessarTeste1Page